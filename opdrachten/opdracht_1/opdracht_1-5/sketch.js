...
function draw() {
  ...
  noStroke(); // Geen rand!
  if(bal1_xPos-bal1_xSize/2<=0 || bal1_xPos+bal1_xSize/2>=width){
    bal1_xSpeed=bal1_xSpeed*-1;
  }
  if(bal1_yPos-bal1_ySize/2<=0 || bal1_yPos+bal1_ySize/2>=height){
    bal1_ySpeed=bal1_ySpeed*-1;
  }
  ...
  stroke("#000"); // Rand (#rgb(a))
  noStroke(); // Geen rand!
  if(bal2_xPos-bal2_xSize/2<=0 || bal2_xPos+bal2_xSize/2>=width){
    bal2_xSpeed=bal2_xSpeed*-1;
  }
  if(bal2_yPos-bal2_ySize/2<=0 || bal2_yPos+bal2_ySize/2>=height){
    bal2_ySpeed=bal2_ySpeed*-1;
  }
